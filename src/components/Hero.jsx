...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${style.paddingY} `}>
    <div className={`flex-1 ${style.flexStart} flex-col sm:px-16 xl:px-0 px-6`}>
      <div className="flex flex-row items-center px-[6px] py-4 bg-discount-gradient rounded-[10px] mb-2">
